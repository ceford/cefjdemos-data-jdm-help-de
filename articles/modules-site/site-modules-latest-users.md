<!-- Filename: Help4.x:Site_Modules:_Latest_Users / Display title: Module: Benutzer – Neueste -->
...
![Neueste Benutzer Modul-Tab](../../../de/images/modules-site/site-modules-latest-users/01-modules-latest-users-module-tab.png)
