...
Das *Datenschutz-Statusprüfungs-Modul* zeigt Informationen über den Datenschutzstatus der Website an.
...
![modules privacy status check module tab](../../../de/images/modules-admin/admin-modules-privacy-status-check/01-modules-privacy-status-check-module-tab.png)
...
- **Informationen** Das Datenschutz-Statusprüfungs-Modul zeigt Informationen über den Datenschutzstatus Ihrer Website an.
