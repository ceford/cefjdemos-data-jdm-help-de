<!-- Filename: Help4.x:Admin_Modules:_User_Menu / Display title: Module: Benutzermenü -->

## Beschreibung

Das Modul *Benutzermenü* zeigt das Benutzermenü in der Titelleiste des Administrators an. Es enthält eine Dropdown-Liste mit möglichen Aktionen wie *Konto bearbeiten* und *Abmelden*.
...
- **Informationen** Dieses Modul zeigt das Benutzermenü an.
