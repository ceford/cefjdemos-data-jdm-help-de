<!-- Filename: Help4.x:Admin_Modules:_Multilingual_Status / Display title: Module: Mehrsprachiger Status -->

## Beschreibung

Der Modultyp *Mehrsprachiger Status* zeigt ein Symbol in der Titelleiste an, um Zugriff auf die mehrsprachigen Parameter in mehrsprachigen Websites zu bieten.
...
![modules multilingual status module tab](../../../de/images/modules-admin/admin-modules-multilingual-status/01-module-tab.png)
...
- **Informationen** Dieses Modul zeigt den Status der mehrsprachigen Parameter an.
