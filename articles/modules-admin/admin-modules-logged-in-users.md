<!-- Filename: Help4.x:Admin_Modules:_Logged-in_Users / Display title: Module: Eingeloggte Benutzer -->

## Beschreibung

Der Modultyp *Eingeloggte Benutzer* zeigt eine Liste der Benutzer an, die
derzeit auf der Website eingeloggt sind. Es wird im Start-Dashboard angezeigt.
...
![module eingeloggte benutzer modul tab](../../../de/images/modules-admin/admin-modules-logged-in-users/01-modules-logged-in-users-module-tab.png)
...
- **Anzuzeigende Benutzer** Die Anzahl der Benutzer, die angezeigt werden sollen (Standard 5).
- **Name** Zeigt den Namen oder Benutzernamen des eingeloggten Benutzers an.
