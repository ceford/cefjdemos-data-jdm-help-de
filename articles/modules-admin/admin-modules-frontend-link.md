<!-- Filename: Help4.x:Admin_Modules:_Frontend_Link / Display title: Module: Frontend-Link -->

## Beschreibung

Das Modul *Frontend-Link* zeigt einen Link zum Frontend am Ende der Titelleiste an.
...
![module frontend link module tab](../../../de/images/modules-admin/admin-modules-frontend-link/01-modules-frontend-link-module-tab.png)
...
- **Informationen** Dieses Modul zeigt die Frontend-Link-Informationen an.
