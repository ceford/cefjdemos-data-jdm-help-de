<!-- Filename: Help4.x:Admin_Modules:_Post_Installation_Messages / Display title: Module: Nachrichten nach der Installation -->

## Beschreibung

Der Modultyp *Nachrichten nach der Installation* zeigt ein Symbol mit der Anzahl der aktiven Nachrichten nach der Installation in der Titelleiste an. Nachrichten können ausgeblendet oder archiviert werden. Wenn keine aktiven Nachrichten vorhanden sind, wird das Modul nicht angezeigt.
...
![modules post installation messages module tab](../../../de/images/modules-admin/admin-modules-post-installation-messages/01-module-tab.png)
...
- **Informationen** Dieses Modul zeigt die neuesten Nachrichten nach der Installation an.
