<!-- Filename: Help4.x:Admin_Modules:_Messages / Display title: Module: Nachrichten -->

## Beschreibung

Das *Nachrichten*-Modul zeigt die Anzahl der privaten Nachrichten in der Titelleiste an.
...
![modules messages module tab](../../../de/images/modules-admin/admin-modules-messages/01-modules-messages-module-tab.png)
...
- **Informationen** Dieses Modul zeigt die Anzahl der privaten Nachrichten an.
