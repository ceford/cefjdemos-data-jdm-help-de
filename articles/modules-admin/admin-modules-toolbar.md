...
Der Modultyp *Werkzeugleiste* zeigt die Symbole der Werkzeugleiste an, die verwendet werden, um Aktionen im gesamten Administratorbereich zu steuern.
...
![modules toolbar module tab](../../../de/images/modules-admin/admin-modules-toolbar/01-modules-toolbar-module-tab.png)
...
- **Informationen** Dieses Modul zeigt die Symbole der Werkzeugleiste an, die verwendet werden, um Aktionen im gesamten Administratorbereich zu steuern.
