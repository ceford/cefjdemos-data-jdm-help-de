...
Der Modultyp *Beliebte Artikel* zeigt eine Liste der beliebtesten veröffentlichten Artikel an, die noch aktuell sind. Einige der angezeigten Artikel könnten bereits abgelaufen sein, auch wenn sie zu den neuesten gehören.
...
![modules popular articles module tab](../../../de/images/modules-admin/admin-modules-popular-articles/01-modules-popular-articles-module-tab.png)
...
- **Kategorie** Wählen Sie Artikel aus einer bestimmten Kategorie oder aus allen Kategorien.
- **Autoren** Ein Filter für die Autoren.
