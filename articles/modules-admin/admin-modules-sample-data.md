<!-- Filename: Help4.x:Admin_Modules:_Sample_Data / Display title: Module: Beispieldaten -->
...
![modules sample data module tab](../../../de/images/modules-admin/admin-modules-sample-data/01-modules-sample-data-module-tab.png)
