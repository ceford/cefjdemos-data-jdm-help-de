<!-- Filename: Help4.x:Admin_Modules:_Title / Display title: Module: Titel -->
...
![modules title module tab](../../../de/images/modules-admin/admin-modules-title/01-modules-title-module-tab.png)
