<!-- Filename: Help4.x:Admin_Modules:_Login_Form / Display title: Module: Login-Formular -->

## Beschreibung

Der Modultyp *Login-Formular* zeigt ein Login-Formular mit Benutzername und Passwort an. Es sollte nicht deaktiviert werden.
...
- **Informationen** Dieses Modul zeigt ein Login-Formular mit Benutzername und Passwort an. Es sollte nicht deaktiviert werden.
