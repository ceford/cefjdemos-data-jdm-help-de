<!-- Filename: Help4.x:Menu_Item:_Edit_User_Profile / Display title: Benutzerprofil bearbeiten -->

## Beschreibung

Der Menüpunkt-Typ **Benutzerprofil bearbeiten** wird verwendet, um ein Formular zu erstellen, das es einem Benutzer ermöglicht, seine eigenen Profileinstellungen zu bearbeiten.
...
Um einen neuen Menüpunkt **Benutzerprofil bearbeiten** zu erstellen:
...
- Wählen Sie **Menüs → \[Name des Menüs\]** aus dem Administrator-Menü (zum Beispiel **Menüs → Hauptmenü**). Dann...
  ...
  - Im Dialogfeld wählen Sie den Punkt *Benutzer* aus, um eine Liste zu öffnen, und wählen dann den Menüpunkt **Benutzerprofil bearbeiten**.

Um einen bestehenden Menüpunkt zur Bearbeitung des Benutzerprofils zu bearbeiten:
