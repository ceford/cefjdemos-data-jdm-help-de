<!-- Filename: Help4.x:Menu_Item:_Create_Request / Display title: Menüpunkt: Anfrage erstellen -->
...
![Menüpunkt Datenschutz Anfrage erstellen Details-Tab](../../../de/images/menu-items/privacy-create-request/01-details-tab.png)
