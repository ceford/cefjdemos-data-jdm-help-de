...
Der Menüpunkt-Typ *Passwort zurücksetzen* wird verwendet, um eine Seite zu erstellen, die ein Formular zum Zurücksetzen des Passworts enthält. Es wird nach der E-Mail-Adresse des Benutzerkontos gefragt und eine E-Mail mit einem Reset-Token an die angegebene Adresse gesendet.
...
Um einen neuen Menüpunkt zum Zurücksetzen des Passworts zu erstellen:
...
- Wählen Sie **Menüs → "Name des Menüs"** aus dem Administrator-Menü (zum Beispiel **Menüs → Hauptmenü**). Dann...
  ...
  - Im Dialogfeld wählen Sie den Punkt *Benutzer* aus, um eine Liste zu öffnen, und wählen dann den Menüpunkt **Passwort zurücksetzen**.

Um einen bestehenden Menüpunkt *Passwort zurücksetzen* zu bearbeiten:
