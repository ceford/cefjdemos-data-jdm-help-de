<!-- Filename: Help4.x:Menu_Item:_Registration_Form / Display title: Registrierungsformular -->
...
![Details-Tab Registrierungsformular](../../../de/images/menu-items/users-registration-form/01-details-tab.png)
