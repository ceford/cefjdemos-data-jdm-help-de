...
![task timeout setting](../../../de/images/maintenance/scheduled-tasks-configuration/01-configure-tasks-tab.png)

- **Aufgabenzeitüberschreitung** Der Standardwert beträgt 300 Sekunden.

### Tab "Fauler Scheduler"

![lazy schedule setting](../../../de/images/maintenance/scheduled-tasks-configuration/02-lazy-scheduler-tab.png)
...
![web cron setting](../../../de/images/maintenance/scheduled-tasks-configuration/03-webcron-tab.png)
