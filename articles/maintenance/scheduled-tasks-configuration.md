<!-- Filename: Help5.x:Scheduled_Tasks:_Options / Display title: Konfiguration geplanter Aufgaben -->
...
![task timeout setting](../../../de/images/maintenance/scheduled-tasks-configuration/01-scheduled-tasks-options-configure-tasks.png)

- **Aufgabenzeitüberschreitung** Der Standardwert beträgt 300 Sekunden.

### Tab "Fauler Scheduler"

![lazy schedule setting](../../../de/images/maintenance/scheduled-tasks-configuration/02-scheduled-tasks-options-lazy-scheduler.png)
...
![web cron setting](../../../de/images/maintenance/scheduled-tasks-configuration/03-scheduled-tasks-options-webcron.png)
